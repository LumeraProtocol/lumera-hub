...
const Skeleton = ({ type = 'text', count = 1, className = '', containerClassName = '' }: SkeletonProps) => {
  ...
  return <span className={`skeleton-container skeleton-container-${type} ${containerClassName}`}>{renderSkeletonItem()}</span>;
};
