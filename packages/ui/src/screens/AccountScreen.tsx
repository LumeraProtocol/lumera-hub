...
export const AccountScreen = () => {
      ...
      series: [
        {
          ...
          data: [
            { value: 1000, name: 'Balance' },
            { value: 100, name: 'Delegation' },
            { value: 100, name: 'Reward' },
            { value: 100, name: 'Unbonding' },
          ]
        }
      ]
    }
  ...
  const calculatePercent = (value: number) => {
    const totalDelegations = delegations.reduce((total, item) => total + Number(item.balance.amount), 0);
    const totalAmount = getTotalReward() + getTotalUnbondingDelegations() + getTotalBalances() + totalDelegations;
    ...
    <div className="space-y-8 text-base">
      <Card elevate size="$4" bordered className='w-full !p-6'>
        <div className='flex items-center gap-4'>
          <div className="rounded-lg grid place-items-center bg-lumera-icon-bg p-2">
            <QrCode className='w-6 h-6 text-lumera-teal' />
          </div>
          <div>
            <h2 className='text-lumera-label'>
      ...
      <Card elevate size="$4" bordered className='w-full !p-6 mt-5'>
        <SectionTitle className='mb-0'>Assets</SectionTitle>
          ...
          {isBalancesLoading || isUnbondingDelegationsLoading || isRewardsLoading || isDelegationsLoading ?
            ...
            <div className='flex items-start justify-between gap-8'>
              <div className='w-5/12 relative'>
                ...
                <ul className='flex justify-between gap-4 text-[12px] mt-3'>
              ...
              <div className='w-7/12'>
                <div className="overflow-y-auto max-h-[330px]">
                  ...
                  {balances.map((balance, index) => (
                    <div className='flex items-center justify-between gap-2 px-4 mb-2' key={index}>
                      <div className="flex items-center gap-2">
                        <div className="rounded-full grid place-items-center recent-activity-icon">
                          <Wallet className="w-5 h-5" style={{ color: COLORS[0] }} />
                        </div>
                        <div className="flex-1">
                          ...
                          <div className="text-xs text-lumera-label">
                            {calculatePercent(Number(balance.amount))}
                          </div>
                        </div>
                      </div>
                      <div className='rounded-full grid place-items-center recent-activity-icon text-sm'>$0</div>
                    </div>
                  ))}
                  ...
                  {delegations.map((delegation, index) => (
                    <div className='flex items-center justify-between gap-2 px-4 mb-2' key={index}>
                      <div className="flex items-center gap-2">
                        <div className="rounded-full grid place-items-center recent-activity-icon">
                          <Layers className="w-5 h-5" style={{ color: COLORS[1] }} />
                        </div>
                        <div className="flex-1">
                          <div className="font-semibold text-sm">
                            {formatToken({
                          ...
                          <div className="text-xs text-lumera-label">
                            {calculatePercent(Number(delegation.balance.amount))}
                          </div>
                        </div>
                      </div>
                      <div className='rounded-full grid place-items-center recent-activity-icon text-sm'>$0</div>
                  ...
                  <div className='flex items-center justify-between gap-2 px-4 mb-2'>
                    <div className="flex items-center gap-2">
                      <div className="rounded-full grid place-items-center recent-activity-icon">
                        <BadgeDollarSign className="w-5 h-5" style={{ color: COLORS[2] }} />
                      </div>
                      <div className="flex-1">
                        <div className="font-semibold text-sm">
                          {formatToken({
                            amount: getTotalReward().toString(),
                            denom: DENOM,
                          })}
                        </div>
                        <div className="text-xs text-lumera-label">
                          {calculatePercent(Number(getTotalReward()))}
                        </div>
                      </div>
                    </div>
                    <div className='rounded-full grid place-items-center recent-activity-icon text-sm'>$0</div>
                  ...
                  <div className='flex items-center justify-between gap-2 px-4 mb-2'>
                    <div className="flex items-center gap-2">
                      <div className="rounded-full grid place-items-center recent-activity-icon">
                        <Link2Off className="w-5 h-5" style={{ color: COLORS[3] }} />
                      </div>
                      <div className="flex-1">
                        <div className="font-semibold text-sm">
                          {formatToken({
                            amount: getTotalUnbondingDelegations().toString(),
                            denom: DENOM,
                          })}
                        </div>
                        <div className="text-xs text-lumera-label">
                          {calculatePercent(Number(getTotalUnbondingDelegations()))}
                        </div>
                      </div>
                    </div>
                    <div className='rounded-full grid place-items-center recent-activity-icon text-sm'>$0</div>
      ...
      <Card elevate size="$4" bordered className='w-full !p-6 mt-5'>
        <SectionTitle className='mb-0'>Delegations</SectionTitle>
        <div className='mt-3 relative'>
          {isDelegationsLoading ?
            <div className="relative min-h-60 flex items-center justify-center">
              <AppLoading
      ...
      {unbondingDelegations?.length ?
        <Card elevate size="$4" bordered className='w-full !p-6 mt-5'>
          <SectionTitle className='mb-0'>Unbonding Delegations</SectionTitle>
          <div className='mt-3 relative'>
            {isAccountLoading ?
              <div className="relative min-h-60 flex items-center justify-center">
                <AppLoading
      ...
      <Card elevate size="$4" bordered className='w-full !p-6 mt-5'>
        <SectionTitle className='mb-0'>Recent Received</SectionTitle>
        <div className='mt-3 relative'>
          {isRecentReceivedLoading ?
            <div className="relative min-h-60 flex items-center justify-center">
              <AppLoading
